...
function createCollegesStore() {
    ...
    return {
        ...
        set data(v: CollegesStore) { data = v; },
    };
}

function createActivitiesStore() {
    let data = $state<ActivitiesStore>(loadStore<ActivitiesStore>('activities', DEFAULT_ACTIVITIES));
    ...
    return {
        get data() { return data; },
        set data(v: ActivitiesStore) { data = v; },
    };
}

function createCalendarStore() {
    let data = $state<CalendarStore>(loadStore<CalendarStore>('calendar', DEFAULT_CALENDAR));
    ...
    return {
        get data() { return data; },
        set data(v: CalendarStore) { data = v; },
    };
}
